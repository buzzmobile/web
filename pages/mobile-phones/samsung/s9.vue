  ...
  <header>
    ...
    <div class="flex shadow py-4">
      <img class="w-1/3" sizes="30vw" srcset="
                ...
                ~/assets/images/galaxy-s9-black-back-900.jpg 900w" 
                src="~/assets/images/galaxy-s9-black-back-360.jpg" 
      ...
      <img class="w-1/3" sizes="30vw" srcset="
                ...
                ~/assets/images/galaxy-s9-purple-back-900.jpg 900w" 
                src="~/assets/images/galaxy-s9-purple-back-360.jpg"
      ...
      <img class="w-1/3" sizes="30vw" srcset="
                ...
                ~/assets/images/galaxy-s9-blue-back-900.jpg 900w" 
                src="~/assets/images/galaxy-s9-blue-back-360.jpg" 
