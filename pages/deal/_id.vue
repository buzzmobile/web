<template>
  <div>
    ...
    <div class="flex flex-col sm:flex-row">
      <div class="sm:w-1/2">image</div>
      <div class="sm:w-1/2">text</div>
    </div>
    <img v-if="imageKey==='s9-midnight-black'" class="w-full sm:w-1/2" sizes="30vw" srcset="
    ...
    <img v-if="imageKey==='s9-plus-midnight-black'" class="w-full sm:w-1/2" sizes="30vw" srcset="
    ...
    <img v-if="imageKey==='s9-lilac-purple'" class="w-full sm:w-1/2" sizes="30vw" srcset="
    ...
    <img v-if="imageKey==='s9-plus-lilac-purple'" class="w-full sm:w-1/2" sizes="30vw" srcset="
    ...
    <img v-if="imageKey==='s9-coral-blue'" class="w-full sm:w-1/2" sizes="30vw" srcset="
    ...
    <img v-if="imageKey==='s9-plus-coral-blue'" class="w-full sm:w-1/2" sizes="30vw" srcset="
      ...
      alt="Samsung S9 Plus in Coral Blue">
    <img v-if="imageKey==='x-silver'" class="w-full sm:w-1/2" src="~/assets/images/iphonex/iphone-x-silver-full.jpg" alt="iPhone X in Silver">
    <img v-if="imageKey==='x-space-grey'" class="w-full sm:w-1/2" src="~/assets/images/iphonex/iphone-x-gray-full.jpg" alt="iPhone X in Space Grey">
